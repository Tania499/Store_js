...
// let product = document.querySelector('div.product')
...
// h5.setAttribute('class', 'prise');
// h6.setAttribute('class', 'btn');

//     let divProduct = document.querySelector('div.product-list').appendChild(div ); 

//     img.setAttribute('src',el.imgUrl);
//     h1.textContent = el.name;
//     h5.textContent = 'Prise: ' + el.price + ' $';
//     h6.textContent = 'Add to card';


// document.querySelector('div.product').appendChild(img ); 
// document.querySelector('div.product').appendChild(h1);
// document.querySelector('div.product').appendChild(h5);
// document.querySelector('div.product').appendChild(h6);
...
let code = "<ul class = 'product-card'></ul>"
for(let key in items){
    code += `<li class = 'product'>
                <img class = 'images' src = "img/${items[key].imgUrl}" alt = "#"></img></br>
                <span class = 'name'>${items[key].name}</span></br>
                <h5 class = 'prise'>Price: ${items[key].price}$</h5></br>
                <button class = 'btn'>Add to card</button>
            </li>`


}
document.getElementById('product-id').innerHTML = code
...
//   li = div.document.getElementsByClassName('product');;
